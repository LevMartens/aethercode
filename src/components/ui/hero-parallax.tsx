...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[250vh] sm:h-[220vh] md:h-[200vh] py-24 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] "
    >
      <Header />
...
export const Header = () => {
  return (
    <div className="relative left-0 top-0 mx-auto w-full max-w-7xl px-4 py-20 md:py-40">
      ...
      <p className="mt-4 md:mt-8 max-w-2xl text-base md:text-xl text-muted-foreground">
